...
/obj/decal/cleanable/blood/pool
	name = "лужа крови"
	desc = "Тёмная лужа крови."
...
/obj/decal/cleanable/blood/pool/proc/update_pool()
	if(blood_amount >= 50)
		icon_state = "pool5"
	else if(blood_amount >= 40)
		icon_state = "pool4"
	else if(blood_amount >= 30)
		icon_state = "pool3"
	else if(blood_amount >= 20)
		icon_state = "pool2"
	else
		icon_state = "pool1"

/obj/decal/cleanable/blood/pool/proc/add_pool_blood(amount)
	blood_amount += amount
	update_pool()
