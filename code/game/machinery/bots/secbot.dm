			...
			if (!src.target.handcuffed && !src.arrest_type)
				...
				spawn(60)
					if (get_dist(src, src.target) <= 1)
						...
						src.frustration = 0
						src.secure_arrest = 0
						playsound(src.loc, pick('sound/voice/scum/bgod.ogg', 'sound/voice/scum/biamthelaw.ogg', 'sound/voice/scum/bsecureday.ogg', 'sound/voice/scum/bradio.ogg', 'sound/voice/scum/binsult.ogg', 'sound/voice/scum/bcreep.ogg'), 50, 0)
