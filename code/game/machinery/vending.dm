...
/obj/machinery/vending/attack_hand(mob/user as mob)
	...
	if(panel_open)
		...
		var/pdat = "<!DOCTYPE html><B>Access Panel</B><br>"
		...
		pdat += "The [(src.wires & WIRE_SCANID) ? "purple" : "yellow"] light is on.<BR></html>"

		user << browse(pdat, "window=vendwires")
		onclose(user, "vendwires")

	var/dat = "<!DOCTYPE html><TT><b>Select an item:</b></TT><br>"
	...
	if (src.product_records.len == 0)
		...
		dat += "</TABLE><br><TT><b>Points available: [points]</b><br></TT></html>"
