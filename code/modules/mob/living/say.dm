/mob/living/say(var/message)
	...
	// :downs:
	if (brainloss >= 60)
		message = dd_replacetext(message, "меня", "мя")
		message = dd_replacetext(message, "ты", "ы")
		message = dd_replacetext(message, "ж", "х")
		message = dd_replacetext(message, "вы", "ы")
		message = dd_replacetext(message, "туда", "тама")
		message = dd_replacetext(message, "что", "шо")
		if(prob(50))
			if(text2ascii(message, 1) < 128)
